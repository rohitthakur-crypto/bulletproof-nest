...
export const META_GRAPH_PAGE_POSTS_PATH = (pageId: string) => `${pageId}/posts`;

export const META_GRAPH_INSTAGRAM_POSTS_PATH = (instagramBusinessId: string) =>
  `${instagramBusinessId}/media`;

export const META_GRAPH_PAGE_MESSAGES_PATH = (pageId: string) => `${pageId}/messages`;
